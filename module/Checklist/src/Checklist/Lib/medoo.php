 ...
 */
require_once 'parsery/ParserSlownik.php';
class medoo
{
	...
	protected $username = 'poldas';

	protected $password = 'zaqwsx';
	...
	protected $database_name = ParserSlownik::DATABASE_NAME;

	protected $option = array(PDO::ATTR_CASE => PDO::CASE_NATURAL);
	...
	public function insert($table, $datas)
	{
		...
		foreach ($datas as $data)
		{
            ...
            debug('INSERT INTO "' . $table . '" (' . implode(', ', $columns) . ') VALUES (' . implode($values, ', ') . ')');
